...
export const updateNote = createAction('[Notes] Update Note', props<{ id: number; dto: CreateNoteDto }>());
...
export const deleteNote = createAction('[Notes] Delete Note', props<{ id: number }>());
export const deleteNoteSuccess = createAction('[Notes] Delete Note Success', props<{ id: number }>());
